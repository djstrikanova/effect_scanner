...
class EffectScanner{
    ...
    async getApproved() {
        const approvedURL = "https://raw.githubusercontent.com/effectai/force-frontend/main/approvedCampaigns.json"
        return new Promise(async function(resolve, reject) {
            console.log("Getting Approved Campaigns and Requesters\n")
            try{
                let approved = {}
